...
// From   Hyperbolic Poincare Weave   https://www.shadertoy.com/view/tljyRR
...
vec3 initDomain(){
    ...
    */
    ...
    // component.
    //float f = 1.0 + (Const.y + 0.1)*0.1;
    //float f = 0.9;
	return vec3(dist, rad, 1. + Const.y*0.00004)/sqrt(d);
...
void mainImage(out vec4 fragColor, in vec2 fragCoord){
    ...
    p = rot2(iTime/16. + Const.x*10.0 )*p;
